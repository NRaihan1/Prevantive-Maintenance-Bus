    ...
    <div class="panel panel-bd lobidrag">
        <div class="panel-body">
            <div class="table-header">
                ...
                <?php echo('Maintenance information'); ?> 
        ...
        <div class="panel-body">
                ...
                <table id="dataTableExample2" class="display compact cell-border" cellspacing="0"  width="100%">
                   <thead>
                        <tr>
                            ...
                            <th><?php echo ('Maintenance issue'); ?></th>
                            <th><?php echo ('Maintenance expire'); ?></th>
                    ...
                    <tbody>
                        <?php
                        if (!empty($vehicle_maintenance)) {
                            $count = 0;
                            foreach ($vehicle_maintenance as $vehicle_fitne) {
                                ?>
                                <tr>
                                    ...
                                    <td><?php echo date("d M Y", strtotime($vehicle_fitne->maintenance_issue)) ?></td>
                                    <td><?php echo date("d M Y", strtotime($vehicle_fitne->maintenance_expire)); ?></td>
            ...
            <?php if ($this->session->userdata('user_type') == 9) { ?>
                                        <td class="no-print">
                                            <a class="green" data-toggle="tooltip" title="<?php echo display('edit')?>" href="<?php echo base_url() . "vehicle/vehicle_fitness_edit/" . $vehicle_fitne->v_maintenance_id; ?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>&nbsp;&nbsp;

                                            <a class="red delete" data-toggle="tooltip" title="<?php echo display('delete');?>"href="<?php echo base_url() . "vehicle/vehicle_fitness_delect/" . $vehicle_fitne->v_maintenance_id; ?>">
