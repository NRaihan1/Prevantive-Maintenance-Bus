<ul class="nav" id="side-menu">
    ...
    <li>
        <a href="#" class="material-ripple"> <i class="hvr-buzz-out fa fa-legal"></i><?php echo display('maintenance'); ?><span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url(); ?>vehicle/vehicle_maintenance_list"><?php echo('Maintenance list')?></a></li>
        </ul>
    </li>
    <li>
